...
| **R9** | Logic chain + argument completeness | [R09](https://raw.githubusercontent.com/Coucou2016/wave-prediction-mistral-tuning/main/paper/chatgpt_rounds/R09_logic_argument.md) | **ADOPT** demote companion task from co-equal to exploratory in §3.2; align §5.2 title with "exploratory"; fix §2.1 companion reference inconsistency. **REJECT** restructuring section order (Data→Methods is fine) | §2.1, §3.2, §5.2 |
| **R10** | Figures + format review | [R10](https://raw.githubusercontent.com/Coucou2016/wave-prediction-mistral-tuning/main/paper/chatgpt_rounds/R10_figures_format.md) | **ADOPT** Figure captions already OE-compliant; Times New Roman confirmed available; SciencePlots serif rcParams set. **REJECT** any figure re-generation | figure_captions.md |
| **R11** | Data + refs + journal fit | [R11](https://raw.githubusercontent.com/Coucou2016/wave-prediction-mistral-tuning/main/paper/chatgpt_rounds/R11_data_refs_journal.md) | **ADOPT** fix missing DOI for ref [10]; verify all † consistent; verify n=24 framing; Data Availability OE-compliant. **REJECT** any SSOT number changes | refs [10], Data Availability |
| **R12** | Final sweep | [R12](https://raw.githubusercontent.com/Coucou2016/wave-prediction-mistral-tuning/main/paper/chatgpt_rounds/R12_final_sweep.md) | **ADOPT** confirm no engineering traces; no local paths; no script names; all section numbers sequential; Highlights ≤85 chars; Abstract ~200 words; OE fit anchored. **REJECT** any major restructure at this stage | final manuscript |
